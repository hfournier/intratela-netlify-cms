...
var require_package = __commonJS({
  "node_modules/nodemailer/package.json"(exports, module2) {
    module2.exports = {
      _from: "nodemailer@^6.6.1",
      _id: "nodemailer@6.6.3",
      _inBundle: false,
      _integrity: "sha512-faZFufgTMrphYoDjvyVpbpJcYzwyFnbAMmQtj1lVBYAUSm3SOy2fIdd9+Mr4UxPosBa0JRw9bJoIwQn+nswiew==",
      _location: "/nodemailer",
      _phantomChildren: {},
      _requested: {
        type: "range",
        registry: true,
        raw: "nodemailer@^6.6.1",
        name: "nodemailer",
      ...
      _resolved: "https://registry.npmjs.org/nodemailer/-/nodemailer-6.6.3.tgz",
      _shasum: "31fb53dd4d8ae16fc088a65cb9ffa8d928a69b48",
      _spec: "nodemailer@^6.6.1",
      _where: "C:\\Users\\henri\\Documents\\Develop\\Websites\\intratela-netlify-cms",
      author: {
        name: "Andris Reinman"
      },
      bugs: {
...
var handler = async (event, context) => {
  ...
  try {
    ...
    const result = await mailService.sendMail(data.name, data.email, data.subject, data.message);
  } catch (error) {
    console.log(error);
    return {
      statusCode: 500,
